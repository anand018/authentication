...
public class ApplicationConstants {
    ...
    public static final String FAILED_TO_SAVE = "Failed to save profile picture. ";
    public static final String SAVED_SUCCESSFULLY = "Profile picture saved successfully";
